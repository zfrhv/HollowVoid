...
public class ModBlocks {
    public static final Block VOID_SOIL = register(
            "void_soil",
            Block::new,
    ...
    private static RegistryKey<Block> keyOfBlock(String name) {
        return RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(HollowVoid.MOD_ID, name));
    }

    private static RegistryKey<Item> keyOfItem(String name) {
        return RegistryKey.of(RegistryKeys.ITEM, Identifier.of(HollowVoid.MOD_ID, name));
    }
